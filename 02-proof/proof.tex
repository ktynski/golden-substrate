...
The Barbero--Immirzi parameter in NGR is
\begin{equation}
  \gamma_{\text{NGR}} \;=\; \frac{\log 4}{\pi \sqrt{3}} \;\approx\; 0.2547.
\end{equation}
Standard LQG fits $\gamma_{\text{LQG}} \approx 0.2375$.  The
$\sim 7\%$ discrepancy is a falsifiable prediction.
\end{theorem}
