...
%% Softer link styling: muted text-color (no red boxes)
...
\newcommand{\eb}[1]{e_{#1}}
\newcommand{\Lk}{L}
\newcommand{\slgo}{\mathfrak{sl}}
\newcommand{\sogo}{\mathfrak{so}}
\newcommand{\spgo}{\mathfrak{sp}}
...
{\large Paper I in a series of three}}
...
\begin{abstract}
\noindent
This is the first paper in a three-paper series.  It establishes
...
of $f_n$ over $\Q$ for $n \ge 2$ is standard
(\cite{selmer1956,smyth1971}).  See \cite[\S2]{two-floor} for
detail.
\end{proof}
...
%% =====================================================================
\section{The Acoustic Primitive and the Clifford Algebra $\Cl(3,1)$}
\label{sec:clifford}
%% =====================================================================
...
\subsection{The Clifford algebra $\Cl(3,1)$}
...
$\{\eta_0, \eta_1, \eta_2, \eta_3\}$ of orthogonal generators
satisfying $\eta_0^2 = +1$ and $\eta_i^2 = -1$ ($i = 1, 2, 3$).
The Clifford algebra $\Cl(3,1)$ generated by these signature-$(3,1)$
vectors is forced; the seam-child asymmetry between $\eta_0$ and
$\{\eta_1, \eta_2, \eta_3\}$ rules out the alternative signature
...
\cite{two-witness-return},
\cref{rmk:hopf-geometric-arena} of \cite{echo-rh}, and
\cref{sec:two-monad-coupling} of \cite{paper-III-monad} for
...
\subsection{The Fano-bivector throat group and its $A_5$ quotient}
\label{sec:throat-a5}
...
(\cref{conj:throat} and \cref{rmk:throat-evidence} in
Paper~II).
\end{remark}

%% =====================================================================
\section{The Substrate: The Exceptional Jordan Algebra $J_3(\Os)$}
\label{sec:albert}
%% =====================================================================
...
\subsection{The derivation algebra is $\fk{f}_{4(4)}$}
...
%% =====================================================================
\section{The Seam at $11$: Two Arithmetic Layers Meet}
\label{sec:seam}
%% =====================================================================
